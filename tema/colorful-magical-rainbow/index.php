...
<div id='main-container'>
    ...
    <div id='invitation-container' class='pure-u-1 pure-u-md-3-8'>
        ...
        <section id='background' class='bg-image'>
            <div class='custom-bg-image'><img src='<?php echo theme_image('bg.png')?>'></div>
            <div class='or-t' data-aos='fade-down'><img src='<?php echo theme_image('or-t.png');?>'></div>
            <div class='or-b' data-aos='fade-up'><img src='<?php echo theme_image('or-b.png');?>'></div>
            <div class='or-m-cloud continuous-sliding-left'><img src='<?php echo theme_image('cloud.png');?>'></div>
        </section>
